...
class TestCommands:
    ...
    def test_a_second_run_reports_the_committed_boundary_without_restarting(
        ...
        # D-091: entry admits the `not_computable` PRD-003 pre-checks, so the chain settles on
        # PRD-004's own diagnostic wall rather than being turned away at the door.
        assert settled.error_code == "diagnostic_not_terminal"
