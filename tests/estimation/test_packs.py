...
PACKS_PATH = REGISTRIES / "method-pack-estimation.v1.json"
...
class TestEveryPack:
    def test_declares_an_estimator_uncertainty_masks_and_figure_builders(
        ...
        assert "primary_contrast_intervals" in pack.figure_builder_ids
