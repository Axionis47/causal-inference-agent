...
from tests.estimation.test_coordinator_e2e import Gateway, prepared_outcome
from tests.preparation.test_coordinator_e2e import REGISTRY, ROOT
...
def test_an_analysis_without_a_prepared_frame_is_refused(fixture: Fixture) -> None:
    ...
    assert (done.status, done.refusal_code) == ("failed", "preparation_not_prepared")
