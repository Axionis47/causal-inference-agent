...
def main() -> None:
    ...
    if client.has_dataset(dataset_name=DATASET):
        ...
        ds = client.create_dataset(dataset_name=DATASET, description="Diff-in-diff lane on pyfixest: Card and Krueger through the router, cigar and marketing forced")
