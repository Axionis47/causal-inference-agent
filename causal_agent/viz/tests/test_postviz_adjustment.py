...
GRAPH = {"treatment": "course", "outcome": "math", "nodes": ["course", "math", "lunch", "gender", "unobserved", "z", "m"],
         "edges": [{"src": "course", "dst": "math"}, {"src": "lunch", "dst": "course", "cites": ["claim:assignment.depends_on"]}, {"src": "lunch", "dst": "math", "cites": ["col:lunch.when"]},
                   {"src": "gender", "dst": "math"}, {"src": "unobserved", "dst": "course", "cites": ["claim:unobserved"]}, {"src": "unobserved", "dst": "math", "cites": ["claim:unobserved"]},
                   {"src": "z", "dst": "course", "cites": ["claim:exclusion"]}, {"src": "course", "dst": "m"}, {"src": "m", "dst": "math"}],
...
def test_causal_graph_roles_edges_and_addresses():
    ...
    assert roles == {"course": "treatment", "math": "outcome", "lunch": "confounder", "gender": "driver", "unobserved": "hidden", "z": "instrument", "m": "mediator", "reading": "excluded"}
...
def test_balance_before_and_after():
    f = A.balance({"lunch": {"before": 0.31, "after": 0.04}, "parental": {"before": 0.12, "after": 0.02}}, "completed_vs_none", 0.1, {"parental": "parental level of education"})
