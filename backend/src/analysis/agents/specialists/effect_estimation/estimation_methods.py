...
Note: Imports are lazy to avoid circular import through src.analysis.agents → specialists
→ effect_estimation → src.causal → src.analysis.agents.base → src.analysis.agents.
"""
...
if TYPE_CHECKING:
    ...
    from src.analysis.agents.base.state import AnalysisState, TreatmentEffectResult
