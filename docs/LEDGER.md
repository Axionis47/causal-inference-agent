...
|---|---|---|
| SYSTEM-CONTRACT.md | `7981271a9fdaf77079c5d6904cacc9900bd04ccfd6a009ded1e804d28c92f4ba` | D-051 revision (design 2,750), 2026-08-25 |
| PRD-001-kaggle-intake-storage.md | `a69337d3bfeac33cc7c017da357df369e01fe2c00d2b8ade429b84eac6913188` | initial freeze |
| PRD-002-causal-design-harness.md | `c997c05ad9d234c259f79bdb412805ba0bb26891abb02ed96a702b7473974c36` | D-051 revision (criterion 39: 2,750), 2026-08-25 |
...
| T-013 | Agents, prompts, LangGraph graph, interrupts, renderer, coordinator, outcome + handoff | PRD-002 (§8, §9, §12.3, §19–§23) | T-010, T-012 | single-session + opus subagents (D-041) | BLOCKED_COMPLEXITY_BUDGET | yes | implementation complete and green (suite 650, e2e approved runs, durable resume) at design 3,338/2,750 with graph.py 790/350; rethink spent pre-code → terminal per §14.1.2 (D-054); awaiting user: design→3,400 + module split, or scope cut |
