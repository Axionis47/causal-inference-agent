...
| T-013 | Agents, prompts, LangGraph graph, interrupts, renderer, coordinator, outcome + handoff | PRD-002 (§8, §9, §12.3, §19–§23) | T-010, T-012 | single-session + opus subagents (D-041) | BLOCKED_COMPLEXITY_BUDGET | yes | spec + pre-code rethink frozen `docs/tasks/T-013-graph-agents-renderer.md`; projected 2,705/2,500 (revised floor 2,685); awaiting user: budget revision 2,500→2,750 (recommended) or scope cut |
