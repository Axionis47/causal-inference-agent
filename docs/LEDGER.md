...
| T-010 | Shared Vertex gateway + LangSmith tracing | shared (SC §10.2–§10.4) | T-009 | single-session + opus subagents (D-041) | IN_PROGRESS | yes | spec frozen `docs/tasks/T-010-gateway-tracing.md`; closes the D-020 revisit |
