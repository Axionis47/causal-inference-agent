...
| T-012 | Validation walls, ask gate, diagnostics, delivery capacity | PRD-002 (§10, §11, §14, §16.3, §13.5) | T-011 | single-session + opus subagents (D-041) | IN_PROGRESS | yes | spec frozen `docs/tasks/T-012-validators-askgate-diagnostics-capacity.md`; walls 1–7 data-driven where expressible |
