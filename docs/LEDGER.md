...
| T-013 | Agents, prompts, LangGraph graph, interrupts, renderer, coordinator, outcome + handoff | PRD-002 (§8, §9, §12.3, §19–§23) | T-010, T-012 | single-session + opus subagents (D-041) | IN_PROGRESS | yes | unblocked by D-051 (design 2,750); spec `docs/tasks/T-013-graph-agents-renderer.md`; projected ≈2,705/2,750 |
