...
export default function Splitter({ width, ...props }: SplitterProps & { width: number | null }) {
  return <div className="splitter" role="separator" aria-orientation="vertical" aria-label="Resize the inspector" aria-valuemin={PANE_MIN} aria-valuenow={width ?? undefined} tabIndex={0} {...props} />;
}
