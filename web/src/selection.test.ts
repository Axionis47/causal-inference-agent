...
const run = (index: number, files: string[] = []): RunView =>
  ({ index, question: "", family: null, specialist: null, status: "ok", run_id: `r${index}`, effect: null, ci_low: null, ci_high: null, estimator: null, decision: {}, decision_record: "", flags: [], checks: [], refutations: [], interpretations: [], estimates: [], feasibility: null, files }) as RunView;
