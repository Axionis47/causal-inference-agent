...
SELECTION: dict[str, Any] = {
    ...
    "figure_builder_ids": ("overlap_bins",), "capacity_report": REF,
    "numerical_tolerances": {"score": 1e-09},
}
MANIFEST: dict[str, Any] = {
    **SELECTION, "compiled_design": REF, "prepared_bundle": REF,
    "preprocessing_rule_ids": (), "registry_versions": VERSIONS,
    "result_cardinalities": {"primary_items": 1}, "method_structure": {},
    "required_visual_evidence_ids": ("primary_estimate",),
}
PLAN: dict[str, Any] = {
...
BUNDLE: dict[str, Any] = {
    **LINEAGE, "compiled_design": REF, "prepared_bundle": REF,
    "row_set_hash": HASH, "capacity_report": REF, "context_manifest": REF, "plan": REF,
